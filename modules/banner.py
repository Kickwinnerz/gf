"""
    ...
    Copyright (C) 2023  Kickwinnerz (github.com/Kickwinnerz)
    ...
    original developer, [kick winner (github.com/Kickwinnerz)], and copying the code
...
banner2 = f"""
        ...
        ░█─── ▀──▀ ▀▀▀▀ ▀──▀ ▀▀▀ ░█▄▄▄█ █▀▀▀ ▀▀▀ ▀▀▀▀ ▀▀▀ ──▀── 　 ░█─── ▀─▀▀ ▀▀▀▀
            ...
            {color.RED}{version}{color.WHITE}            {color.WHITE}By github.com/Kickwinnerz 
"""
...
banner4 = f"""
    ...
    |____|   |___|  /\____/|___|  /\___  >_______  /   __/|____/\____/|__||__|    |____|     |__|   \____/
        ...
        {color.RED}{version}{color.WHITE}                             {color.WHITE}By github.com/kick
"""
banner5 = f"""
...
"""
"""
Copyright © 2023 Kickwinnerz (github.com/Kickwinnerz)
"""
